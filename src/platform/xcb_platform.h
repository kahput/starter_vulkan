	...
	struct {
		...
		union {
			struct {
				...
				PFN_xcb_disconnect xcb_disconnect;
				...
				PFN_xcb_get_geometry xcb_get_geometry;
				PFN_xcb_get_geometry_reply xcb_get_geometry_reply;
...
bool xcb_platform_create_vulkan_surface(Platform *platform, struct VkInstance_T *instance, struct VkSurfaceKHR_T **surface);
