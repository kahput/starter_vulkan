...
bool x11_platform_startup(struct platform *platform);
void x11_platform_shutdown(struct platform *platform);

void x11_platform_poll_events(struct platform *platform);
bool x11_platform_should_close(struct platform *platform);

void x11_platform_get_window_size(struct platform *platform, uint32_t *width, uint32_t *height);
void x11_platform_get_framebuffer_size(struct platform *platform, uint32_t *width, uint32_t *height);

struct VkSurfaceKHR_T;
struct VkInstance_T;

bool x11_platform_create_vulkan_surface(struct platform *platform, struct VkInstance_T *instance, struct VkSurfaceKHR_T **surface);
