...
const VkPipelineStageFlags resource_usage_to_vulkan_pipeline_stage[RESOURCE_USAGE_MAX] = {
	...
	[RESOURCE_USAGE_DEPTH_STENCIL_ATTACHMENT] = VK_PIPELINE_STAGE_EARLY_FRAGMENT_TESTS_BIT | VK_PIPELINE_STAGE_LATE_FRAGMENT_TESTS_BIT,
...
const VkAccessFlags resource_usage_to_vulkan_access_flags[RESOURCE_USAGE_MAX] = {
	...
	[RESOURCE_USAGE_DEPTH_STENCIL_ATTACHMENT] = VK_ACCESS_DEPTH_STENCIL_ATTACHMENT_READ_BIT | VK_ACCESS_DEPTH_STENCIL_ATTACHMENT_WRITE_BIT,
...
const VkImageLayout resource_usage_to_vulkan_image_layout[RESOURCE_USAGE_MAX] = {
	...
	[RESOURCE_USAGE_DEPTH_STENCIL_ATTACHMENT] = VK_IMAGE_LAYOUT_DEPTH_STENCIL_ATTACHMENT_OPTIMAL,
};
