...
static String8 uniform_type_to_string[UNIFORM_TYPE_MAX] = {
	[UNIFORM_TYPE_IMAGE] = scomp("UNIFORM_TYPE_IMAGE"),
	[UNIFORM_TYPE_STORAGE_IMAGE] = scomp("UNIFORM_TYPE_STORAGE_IMAGE"),
	[UNIFORM_TYPE_SAMPLER] = scomp("UNIFORM_TYPE_SAMPLER"),
	[UNIFORM_TYPE_SAMPLER_WITH_IMAGE] = scomp("UNIFORM_TYPE_SAMPLER_WITH_IMAGE"),
	[UNIFORM_TYPE_UNIFORM_BUFFER] = scomp("UNIFORM_TYPE_UNIFORM_BUFFER"),
	[UNIFORM_TYPE_STORAGE_BUFFER] = scomp("UNIFORM_TYPE_STORAGE_BUFFER"),
	[UNIFORM_TYPE_UNIFORM_BUFFER_DYNAMIC] = scomp("UNIFORM_TYPE_UNIFORM_BUFFER_DYNAMIC"),
	[UNIFORM_TYPE_STORAGE_BUFFER_DYNAMIC] = scomp("UNIFORM_TYPE_STORAGE_BUFFER_DYNAMIC"),
};
